...
class XlnetProcessor(object):
    ...
    def get_labels(self, data_dir='./pyclassifier_multi/dataset', data_name="train.tsv", split_symbol='    ', multi_symbol=','):
        """See base class."""
        if os.path.exists(config['label_list'] / 'label_list_xlnet.json'):
            ...
            if os.path.exists(config['label_list'] / 'label_list_xlnet.json') is False:
    ...
    def create_examples(self,lines,example_type,cached_examples_file,multi_symbol=','):
        '''
