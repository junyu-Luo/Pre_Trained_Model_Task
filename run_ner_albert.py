...
def main():
    ...
    parser.add_argument("--model_name_or_path", default='./model_pretrain/albert/albert-base', type=str)
    parser.add_argument("--output_dir", default='output', type=str)
    parser.add_argument("--config_name", default="./model_pretrain/albert/albert-base/config.json", type=str)
    parser.add_argument("--tokenizer_name", default="./model_pretrain/albert/albert-base/vocab.txt", type=str)
    ...
    model = AlbertCrfForNer.from_pretrained(args.model_name_or_path, from_tf=bool(".ckpt" in args.model_name_or_path),
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        tokenizer = AlbertConfig.from_pretrained(args.output_dir, do_lower_case=args.do_lower_case)
        ...
        for checkpoint in checkpoints:
            ...
            model = AlbertCrfForNer.from_pretrained(checkpoint, config=config)
            model.to(args.device)
